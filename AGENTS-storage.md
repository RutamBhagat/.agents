...
- Split large files into small focused modules when the line count is above 300 because of your changes
...
- Build the smallest working end-to-end path first in the simplest happy path manner with least lines of code possible by refering to the documentation using context7
